...
$test=0;
	...
	$res = mysqli_query($con,"SELECT * FROM Following WHERE UserID='$UserID' AND ShopID='$ShopID'");
	while($row = mysqli_fetch_assoc($res)){
   ...
   $sql="INSERT INTO Following (UserID,ShopID) VALUES ('$UserID','$ShopID');";
...
//	echo json_encode($key);
			...
			$sql="DELETE FROM Following WHERE UserID='$UserID' AND ShopID='$ShopID'";
		   if(mysqli_query($con,$sql))
		   {
