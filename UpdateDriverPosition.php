...
$CurrentLongt  = $_POST["CurrentLongt"];
...
if($FirebaseDriverToken==""){
   $sql="UPDATE Drivers SET CurrentLat='$CurrentLat',CurrentLongt='$CurrentLongt' WHERE DriverID=$DriverID";
}else{
	 $sql="UPDATE Drivers SET CurrentLat='$CurrentLat',CurrentLongt='$CurrentLongt',FirebaseDriverToken='$FirebaseDriverToken' WHERE DriverID=$DriverID";
}
