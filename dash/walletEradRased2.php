...
$resCfg = mysqli_query($con, "SELECT getMoneyPerc FROM OrdersJiblerpercentage");
$cfgRow = mysqli_fetch_assoc($resCfg);
$getMoneyPerc = $cfgRow["getMoneyPerc"] ?? 0;
...
// Withdrawal transactions (UserID = 0 pattern used in original = admin/system withdrawals)
...
$resChart = mysqli_query($con, "SELECT MONTH(CreatedAtSendMoneyTransactions) AS Month, COUNT(*) AS Total
    FROM SendMoneyTransactions
    WHERE YEAR(CreatedAtSendMoneyTransactions) = '$currentYear'
    GROUP BY MONTH(CreatedAtSendMoneyTransactions)");
...
<head>
    ...
    <title>Withdrawal Commission | QOON</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        .kpi-master { display: flex; align-items: center; justify-content: space-between; background: linear-gradient(135deg, #059669, #10B981); border-radius: 20px; padding: 30px 40px; color: #FFF; margin-bottom: 30px; box-shadow: var(--shadow-float); flex-shrink: 0; }
    ...
    <main class="main-panel">
        <header class="header">
            <div class="breadcrumb">
                ...
                <span>/</span>
                <span style="color: var(--accent-purple);">Withdrawal Commission</span>
            </div>
        </header>

        <div class="kpi-master">
            <div>
                <h4>Balance Withdrawal Total Commissions</h4>
                <h1><?= number_format($BalanceWithComm, 2) ?> <span>MAD</span></h1>
            </div>
            <div style="display:flex; gap:12px; flex-wrap:wrap;">
                <div class="kpi-badge">
                    <small>Withdrawal Fee Rate</small>
                    <strong><?= $getMoneyPerc ?>%</strong>
                </div>
                <div class="kpi-badge">
                    <small>Share of Total Income</small>
                    <strong><?= $TotalIncome > 0 ? number_format(($BalanceWithComm / $TotalIncome) * 100, 1) : '0' ?>%</strong>
                </div>
            </div>
        </div>
        ...
        <div class="rev-channels">
            ...
            <a href="walletEradRased2.php" class="channel-card active">
            ...
            <div class="table-container">
                <div class="table-head">
                    <h2 style="font-size:18px; font-weight:800;">
                        <i class="fas fa-money-bill-wave" style="color:var(--accent-purple);"></i> Withdrawal Commission Log
                    </h2>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td colspan="4" style="text-align:center; padding:30px; color:var(--text-gray);">No withdrawal commission logs found.</td></tr>
                        <?php endif; ?>
                ...
                <div class="pagination">
                    <span>Withdrawal Commission Records</span>
        ...
        <div class="stats-row" style="margin-bottom:20px;">
            <div class="stat-item">
                <span>Total Withdrawal Commission</span>
                <strong><?= number_format($BalanceWithComm, 2) ?> MAD</strong>
            </div>
            <div class="stat-item">
                <span>Withdrawal Fee Rate</span>
                <strong><?= $getMoneyPerc ?>%</strong>
            </div>
            <div class="stat-item">
