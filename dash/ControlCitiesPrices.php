                           ...
                           <div class="block-element">
						      <div class="form-4 m-b-20">
								...
								<?php                 require "conn.php";
                                     ...
                                     $res = mysqli_query($con,"SELECT * FROM `Countries` WHERE CountryID = 1");

                                        $result = array();
                        
                                        while($row = mysqli_fetch_assoc($res)){
											
											$CityName   = $row["EnglishName"];
											$BoostPrice = $row["BoostPrice"];
											$DeliveryZoneID = $row["CountryID"];
                                    
                                    ?> 
							  
                                 <form action="BoostCityPricesApi.php" method="POST">
                                    <div class="row category-adding" style="background:#c1272d;">
                                       <div class="col-md-9 col-lg-5 col-sm-9 col-12" >
										   <input type="hidden" name="DeliveryZoneID" value="<?php echo $DeliveryZoneID ?>" /> 	
										   <input type="hidden" name="Type" value="Country" /> 
                                          <input class="field-style2" value="<?php echo $CityName; ?>" placeholder="CityName" name="CityName" readonly="readonly">
                                       </div>
									   <div class="col-md-9 col-lg-4 col-sm-9 col-12">
                                          <input type="number" class="field-style2" value="<?php echo $BoostPrice ; ?>"placeholder="BoostPrice" name="BoostPrice">
                                       </div>
                                       <div class="col-md-3 col-lg-3 col-sm-3 col-12">
                                          <input type="submit" class="submit-btn2" value="Update" name="">
                                       </div>
                                    </div>
                                 </form>
								 <br>
