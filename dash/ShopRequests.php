...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  $sql="UPDATE AdminNotification SET AdminNotificationStatus = 'SEEN' WHERE AdminNotificationAction = 'PAYREQUEST'";
         ...
         <main class="right-content">
            ...
            <section class="main-content">
               <div class="container">
                  ...
                  <div class="row" >
                     <div class="col-md-6 col-lg-6 col-sm-12 col-12" style="width:100%;">
                           ...
                           <div class="table-wrapper">
                              ...
                              <table class="table-1" id="tbl_exporttable_to_xls">
                                 ...
                                 <tbody>
                                     <?php
                                    require "conn.php";
                                        $res = mysqli_query($con,"SELECT * FROM RequestPay JOIN Shops ON RequestPay.ShopID = Shops.ShopID order by RequestPay.RequestPayID desc limit 0,10");
                            ...
                            while($row = mysqli_fetch_assoc($res)){
									...
									$CreatedAtShopTransaction = $row["CreatedAtRequestPay"];
            
                                ?>
                                    <tr>
                                       <td class="image-col col-blue1"> <img src="<?php echo $ShopLogo; ?>"> </td> 
									   <td class="col-grey1 text-center" ><?php echo $ShopName ?> </td> 
