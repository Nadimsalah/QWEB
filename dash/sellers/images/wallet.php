               ...
               <div class="container">
                  ...
                  <div class="row">
                     <div class="col-md-3 col-lg-3 col-sm-6 col-12">
                        <div class="custom-box1">
                           <div class="custom-box1-head">
                              <h5> <img src="images/nav-icon11.png"> Jibler.   </h5>
                              <h4> <?php echo $sum; ?> MAD </h4>
                           </div>
                           <div class="custom-box1-data">
                              <img src="images/line-1.png">
                              <span class="col-grey1"> <span class="col-green2"> 0+   </span> more <br/> from last week  </span>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-3 col-lg-3 col-sm-6 col-12">
                        <div class="custom-box1">
                           <div class="custom-box1-head">
                              <h5> <img src="images/nav-icon11.png"> Jibler Partner </h5>
                              <h4> <?php echo $sum; ?> MAD </h4>
                           </div>
                           <div class="custom-box1-data">
                     ...
                     <div class="col-md-3 col-lg-3 col-sm-6 col-12">
                        <div class="custom-box1">
                           <div class="custom-box1-head">
                              <h5> <img src="images/nav-icon11.png"> Jibler Driver Cash out </h5>
                              <h4> <?php echo $OrderPrice; ?> MAD </h4>
                           </div>
                           <div class="custom-box1-data">
                     ...
                     <div class="col-md-3 col-lg-3 col-sm-6 col-12">
                        <div class="custom-box1">
                           <div class="custom-box1-head">
                              <h5> <img src="images/nav-icon11.png"> Jibler Driver Cash back </h5>
                              <h4> <?php echo round($Money/100); ?> MAD </h4>
                           </div>
                           <div class="custom-box1-data">
