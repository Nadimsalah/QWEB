         ...
         <main class="right-content">
            ...
            <section class="main-content">
               <div class="container">
                  ...
                  <div class="row" >
                     <div class="col-md-6 col-lg-9 col-sm-12 col-12" style="width:100%;">
                        <div class="custom-block3">
                           <div class="block-element">
                              <div class="sec-head3">
							  
                                 <h4> Drivers </h4>
								 <button class="field-style3" onclick="ExportToExcel('xlsx')">Export table to excel</button>
								 <form method="GET" action="PaidDrivers.php">
								 From date <input type="date" name="date1" class="field-style3" required />
								 To date <input type="date" name="date2" class="field-style3" required />
								 <input type="submit" value="filter" class="field-style3"  />
								 </form>
                           ...
                           <div class="table-wrapper">
                              ...
                              <table class="table-1" id="tbl_exporttable_to_xls">
                                 <thead>
									...
									<th class="text-center"> Photo </th>
                                       ...
                                       <th class="text-center"> DriverID </th>
                                 ...
                                 <tbody>
									...
									if($date1==""){
                                        $res = mysqli_query($con,"SELECT * FROM DriverTransactions JOIN Drivers ON DriverTransactions.DriverID = Drivers.DriverID WHERE Address = 'cash_plus' AND CreatedAtDriverTransactions LIKE '%$Today%'");
                                    }else{
										
										$res = mysqli_query($con,"SELECT * FROM DriverTransactions JOIN Drivers ON DriverTransactions.DriverID = Drivers.DriverID WHERE Address = 'cash_plus' AND CreatedAtDriverTransactions >= '$date1' AND  CreatedAtDriverTransactions <='$date2'");
                            ...
                            while($row = mysqli_fetch_assoc($res)){
                                    ...
                                    $DriverPhone = $row["PersonalPhoto"];
                                    $FName   = $row["FName"];
									$LName   = $row["LName"];
                                    $Money = $row["Money"];
									$DriverID = $row["DriverID"];
									$CreatedAtDriverTransactions = $row["CreatedAtDriverTransactions"];
                                ...
                                ?>
                                    ...
                                    <tr>
                                       <td class="col-grey1 text-center"> <img style="height:60px;" src="<?php echo $DriverPhone; ?>"> </td> 
									   <td class="col-grey1 text-center" ><?php echo $FName . ' ' . $LName    ?> </td> 
                                       <td class="col-grey1 text-center"> <?php echo $Money; ?> MAD </td>
                                       <td class="status-col1 text-center">  <?php echo $DriverID; ?> </td>
									   <td class="status-col1 text-center">  <?php echo $CreatedAtDriverTransactions ; ?> </td>
                                    </tr>
                                 <?php 
	 ...
	 <script>
        ...
        function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('DriverPaidMoney.' + (type || 'xlsx')));
        }
