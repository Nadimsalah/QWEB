                        ...
                        <div class="custom-block3">
                           ...
                           <div class="table-wrapper">
                              ...
                              <table class="table-1" id="tbl_exporttable_to_xls">
                                 ...
                                 <tbody>
									...
									$Today = date('Y-m-d');
                                        ...
                                        $res = mysqli_query($con,"SELECT * FROM Orders JOIN Drivers ON Orders.DelvryId = Drivers.DriverID JOIN Shops ON Orders.ShopID = Shops.ShopID WHERE (OrderState='Rated' OR OrderState='Done') AND Orders.PaidForDriver != 'Paid' AND Shops.Type = 'Our'");
                            ...
                            while($row = mysqli_fetch_assoc($res)){
                                    ...
                                    $FName   = $row["FName"];
									$LName   = $row["LName"];
                                    $Money = $row["OrderPriceFromShop"];
									$DriverID = $row["DriverID"];
									$CreatedAtDriverTransactions = $row["CreatedAtOrders"];
	 ...
	 <script>
        ...
        function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('DriverNotPaidMoney.' + (type || 'xlsx')));
        }
